...
$sql = "SELECT * FROM signup WHERE score > 0 ORDER BY score DESC ";
             ...
             <table>
                 <thead>
                     <tr>
                         ...
                         <th> point <span class="icon-arrow">&UpArrow;</span></th>
                         <!-- <th> Challenges <span class="icon-arrow">&UpArrow;</span></th> -->
                     </tr>
                 </thead>
                 <tbody>
                    <?php
                    
                    foreach ($row as $inx => $data) {
                        ?>
                     <tr>
                         <td> <?= $inx + 1 ?> </td>
                         <td> <img src="" alt=""><?= $data['username']; ?></td>
                         <td> <?= isset($ranks[$inx]) ? $ranks[$inx] : $inx + 1 . 'th' ?> </td>
                         <td> India </td>
                         <td>
                             <p ><?= $data['score'] ?></p>
                         </td>
